export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx79a24a09494e94a7",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b657a4e1451470b228cfa09b9c3244c7",
   ...
   */
  USERS: [o-czp5xRqEiGfz3Mc7nTaMT9yIXY
    {
      // 想要发送的人的名字
    name: "朱医生",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "朱医生", "year": "2000", "date": "10-17"},
        {"type": "节日", "name": "表白纪念日", "year": "2022", "date": "05-24"},
